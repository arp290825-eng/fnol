...
"[project]/Autonomous-Claims-Orchestrator/frontend/app/api/claims/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$Autonomous$2d$Claims$2d$Orchestrator$2f$frontend$2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getApiUrl"])('api/claims'), {
            method: 'GET',
            headers: {
...
async function POST(request) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Autonomous$2d$Claims$2d$Orchestrator$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(result);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8571b05._.js.map