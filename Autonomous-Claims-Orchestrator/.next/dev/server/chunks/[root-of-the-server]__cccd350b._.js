...
"[project]/Autonomous-Claims-Orchestrator/lib/imapIngestion.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * FNOL-related. Only FNOL emails are ingested; others are skipped.
 * When OPENAI_API_KEY is missing, ingests all (no filter).
...
async function syncInboxFromIMAP() {
    const result = {
        success: false,
        ingested: 0,
        scanned: 0,
    ...
    try {
        ...
        const existingIds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Autonomous$2d$Claims$2d$Orchestrator$2f$lib$2f$ingestedClaims$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getExistingMessageIds"])();
        ...
        try {
            ...
            for await (const msg of messages){
                try {
                    ...
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$Autonomous$2d$Claims$2d$Orchestrator$2f$lib$2f$ingestedClaims$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isDuplicateEmail"])(subject, from, messageId, dateHeader, existingIds)) {
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Autonomous$2d$Claims$2d$Orchestrator$2f$lib$2f$ingestedClaims$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveIngestedClaim"])(from, to, subject, emailBody, attachmentFiles, 'imap', dedupKey, messageId || undefined);
                    result.ingested++;
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Autonomous$2d$Claims$2d$Orchestrator$2f$lib$2f$ingestedClaims$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addDedupKeysToSet"])(existingIds, subject, from, messageId, dedupKey);
                    if (!INCLUDE_READ) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Autonomous$2d$Claims$2d$Orchestrator$2f$lib$2f$imapIngestion$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Autonomous-Claims-Orchestrator/lib/imapIngestion.ts [app-route] (ecmascript)");
;
;
async function POST() {
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Autonomous$2d$Claims$2d$Orchestrator$2f$lib$2f$imapIngestion$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["syncInboxFromIMAP"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cccd350b._.js.map